...
let-env PROMPT_INDICATOR = { $"(ansi -e { fg: '#706EFF'}) $ " }
let-env PROMPT_INDICATOR_VI_INSERT = { $"(ansi -e { fg: '#706EFF'})$ " }
let-env PROMPT_INDICATOR_VI_NORMAL = { $"(ansi -e { fg: '#706EFF'}):: " }
let-env PROMPT_MULTILINE_INDICATOR = { $"(ansi -e { fg: '#706EFF'})::: " }
